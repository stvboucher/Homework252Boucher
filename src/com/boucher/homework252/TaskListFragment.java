...
public class TaskListFragment extends ListFragment {
	...
	public void selectNewPosition(int listPosition)	{
		if (mModel.getNumberofItems() > 0) {
			setActivatedPosition(listPosition);
			
			if ((listPosition >= mModel.getNumberofItems()) ||
			    (listPosition == ListView.INVALID_POSITION)) {
				mCallbacks.onItemSelected(0);
			}
			else {
				mCallbacks.onItemSelected(listPosition);
			}
		}
	}
}
